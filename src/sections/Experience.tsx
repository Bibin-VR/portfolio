      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mb-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="mono text-[10px] tracking-[0.2em] uppercase text-[rgba(245,245,245,0.3)]">04 / Experience</span>
          </div>
          <h2 className="text-3xl font-bold text-[#F5F5F5] mono mb-3">Execution Log</h2>
                ...
                <div className={`ml-16 md:ml-0 md:w-[calc(50%-2rem)] ${
                  ...
                  <div className="gh-card p-6 hover-lift overflow-hidden relative">
                    ...
                    <div className="flex items-center gap-2 mb-4 pb-4 border-b border-[rgba(255,255,255,0.06)]">
                      <GitCommit className="w-3.5 h-3.5 text-[rgba(245,245,245,0.25)]" />
                      <span className="mono text-[10px] tracking-widest text-[rgba(245,245,245,0.3)]">commit</span>
                      <span className="mono text-xs text-[#FFFFFF]">{exp.commitHash}</span>
                    </div>

                    {/* Role & Company */}
                    <div className="mb-4">
                      <h3 className="text-lg font-semibold text-[#F5F5F5] mono mb-1">
                        {exp.role}
                      </h3>
                      <div className="flex items-center gap-2 text-[rgba(245,245,245,0.5)]">
                        <span className="text-sm mono">{exp.company}</span>
                      </div>
                    </div>

                    {/* Meta Info */}
                    <div className="flex flex-wrap items-center gap-4 mb-4 text-sm text-[rgba(245,245,245,0.4)]">
                    ...
                    <div className="space-y-2">
                      {exp.description.map((item, i) => (
                        <div key={i} className="flex items-start gap-2">
                          <span className="text-[rgba(245,245,245,0.3)] mt-1.5 text-xs">›</span>
                          <p className="text-xs text-[rgba(245,245,245,0.5)] leading-relaxed">{item}</p>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-[rgba(255,255,255,0.05)] flex items-center justify-between">
                      <span className="mono text-[10px] text-[rgba(245,245,245,0.25)]">Author: Bibin V R</span>
                      <a 
                        href="#"
                        className="flex items-center gap-1 text-[10px] text-[#FFFFFF] hover:opacity-70 transition-opacity mono"
                      >
                        <span>Details</span>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <div className="h-px w-8 bg-[rgba(255,255,255,0.15)]" />
            <h3 className="text-xl font-semibold text-[#F5F5F5] mono">Education</h3>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex items-start gap-4">
              <div className="p-3" style={{ border: '1px solid rgba(255,255,255,0.07)' }}>
                <Cpu className="w-4 h-4 text-[rgba(245,245,245,0.5)]" />
              </div>
              <div>
                <h4 className="font-semibold text-[#F5F5F5] mono text-sm mb-1">
                  B.Tech - Robotics, AI & ML
                </h4>
                <p className="text-xs text-[rgba(245,245,245,0.4)] mono mb-1">Srinivas University, Mangalore</p>
                <p className="mono text-[10px] text-[rgba(245,245,245,0.25)]">Dec 2020 - May 2024</p>
              </div>
            </div>

            <div className="flex items-start gap-4">
              <div className="p-3" style={{ border: '1px solid rgba(255,255,255,0.07)' }}>
                <Factory className="w-4 h-4 text-[rgba(245,245,245,0.5)]" />
              </div>
              <div>
                <h4 className="font-semibold text-[#F5F5F5] mono text-sm mb-1">
                  Pre-University - PCMB
                </h4>
                <p className="text-xs text-[rgba(245,245,245,0.4)] mono mb-1">
                  Sri Subrahmanyeshwara PU College
                </p>
                <p className="mono text-[10px] text-[rgba(245,245,245,0.25)]">Jul 2017 - May 2019</p>
              </div>
            </div>
          </div>
        </div>
